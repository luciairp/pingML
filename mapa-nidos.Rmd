...
ggsave("pinguinera.png",ping_plot,width = 40,
       height = 40,units = "cm" ,dpi = 300, ) #png
...
mata_plot <- nid_estaca_coord %>%
  ...
  theme_light()+
  facet_wrap(~año)+
  labs(y = "latitud", x = "longitud", title = "Proporción de matas por estaca") +
  theme_bw()+ 
  annotation_scale(location = "br", width_hint = 0.3,  
                   pad_x = unit(1, "cm"), pad_y = unit(0.5, "cm"))+
  annotation_north_arrow( location = "tl", pad_x = unit(0.2, "in"), pad_y = unit(0.1, "in"),
...
ggsave("prop_mata.png",mata_plot,width = 40,
       height = 40,units = "cm" ,dpi = 300, ) #png
...
cueva_plot <- nid_estaca_coord %>%
  ...
  theme_light()+
  facet_wrap(~año)+
  labs(y = "latitud", x = "longitud", title = "Proporcion de cuevas por estaca") +
  theme_bw()+ 
  annotation_scale(location = "br", width_hint = 0.3,  
                   pad_x = unit(1, "cm"), pad_y = unit(0.5, "cm"))+
  annotation_north_arrow( location = "tl", pad_x = unit(0.2, "in"), pad_y = unit(0.1, "in"),
...
ggsave("prop_cueva.png",cueva_plot,width = 40,
       height = 40,units = "cm" ,dpi = 300, ) #png
