...
datos_ord <- data %>% 
  ...
  filter(obs > 0) %>% 
  uncount(weights = obs) %>% 
  select(estaca, distancia, año, tipo_nido) %>% 
  ...
  mutate(Region.Label = "coloniaML",
         Effort = 1,
         Area = 350000) %>% 
  add_row(Sample.Label = "42", distance = NA, año = 2018, tipo_nido = NA, Region.Label = "coloniaML", Effort = 1, Area = 350000) %>% 
   add_row(Sample.Label = "42", distance = NA, año = 2019, tipo_nido = NA, Region.Label = "coloniaML", Effort = 1, Area = 350000) %>% 
  add_row(Sample.Label = "42", distance = NA, año = 2021, tipo_nido = NA, Region.Label = "coloniaML", Effort = 1, Area = 350000) %>% 
  add_row(Sample.Label = "1", distance = NA, año = 2021, tipo_nido = NA, Region.Label = "coloniaML", Effort = 1, Area = 350000) %>% 
  mutate(
...
```{r}
cp <- c(0:20)
y2015 <- ds(datos_ord %>% filter(año == '2015'),transect = "point", key = "unif", cutpoints = cp, adjustment=NULL, truncation = 20)
y2016 <- ds(datos_ord %>% filter(año == '2016'),transect = "point", key = "unif", cutpoints = cp, adjustment=NULL, truncation = 20)
y2017 <- ds(datos_ord %>% filter(año == '2017'),transect = "point", key = "unif", cutpoints = cp, adjustment=NULL, truncation = 20)
y2018 <- ds(datos_ord %>% filter(año == '2018'),transect = "point", key = "unif", cutpoints = cp, adjustment=NULL, truncation = 20)
y2019 <- ds(datos_ord %>% filter(año == '2019'),transect = "point", key = "unif", cutpoints = cp, adjustment=NULL, truncation = 20)
y2021 <- ds(datos_ord %>% filter(año == '2021'),transect = "point", key = "unif", cutpoints = cp, adjustment=NULL, truncation = 20)
